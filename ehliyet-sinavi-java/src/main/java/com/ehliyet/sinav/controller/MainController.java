...
public class MainController {
    ...
    // Spring Security'nin /logout endpointi için Whitelabel hatasını önle
    @GetMapping("/logout")
    public String logoutRedirect() {
        // Sadece login sayfasına yönlendir, gerçek logout işlemi SecurityFilterChain'de
    ...
    public String loginPage(@RequestParam(value = "error", required = false) String error,
        ...
        if (logout != null) {
            ...
            model.addAttribute("success", "Başarıyla çıkış yaptınız.");
        }
        return "login";
    }
